...
import { Text } from "../12-hook/text";
import markup from "!!raw-loader!../12-hook/client-code/index";
import style from "!!raw-loader!../12-hook/client-code/style";
import script from "!!raw-loader!../12-hook/client-code/script";
import { Client } from "../12-hook/client-app";

export const Hook = ({ container }) => {
