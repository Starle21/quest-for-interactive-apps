...
import { Text } from "../15-memoization/text";
import markup from "!!raw-loader!../15-memoization/client-code/index";
import style from "!!raw-loader!../15-memoization/client-code/style";
import script from "!!raw-loader!../15-memoization/client-code/script";
import { Client } from "../15-memoization/client-app";

export const Memoization = ({ container }) => {
