...
import { Text } from "../08-exponential-code-increase/text";
import markup from "!!raw-loader!../08-exponential-code-increase/client-code/index";
import style from "!!raw-loader!../08-exponential-code-increase/client-code/style";
import script from "!!raw-loader!../08-exponential-code-increase/client-code/script";
import { Client } from "../08-exponential-code-increase/client-app";

export const ExponentialCodeIncreaseViz = ({ container }) => {
