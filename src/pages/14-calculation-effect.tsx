...
import { Text } from "../14-calculation-effect/text";
import markup from "!!raw-loader!../14-calculation-effect/client-code/index";
import style from "!!raw-loader!../14-calculation-effect/client-code/style";
import script from "!!raw-loader!../14-calculation-effect/client-code/script";
import { Client } from "../14-calculation-effect/client-app";

export const CalculationEffect = ({ container }) => {
