...
import { Text } from "../09-no-single-originating-source/text";
import markup from "!!raw-loader!../09-no-single-originating-source/client-code/index";
import style from "!!raw-loader!../09-no-single-originating-source/client-code/style";
import script from "!!raw-loader!../09-no-single-originating-source/client-code/script";
import { Client } from "../09-no-single-originating-source/client-app";

export const NoSingleOriginatingSource = ({ container }) => {
